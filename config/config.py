...
OWNER = int(os.getenv("OWNER", "975789354"))
...
OWNER_ID = list(map(int, getenv("OWNER_ID", "975789354").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/fps90/Hot")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")
GIT_TOKEN = getenv("GIT_TOKEN","")
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/En_d12")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/QO_3O") 
